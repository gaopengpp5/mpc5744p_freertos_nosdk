...
/*========================================================================*/
void dummy 						  (void);
extern void pit_ch1_ISR();

extern void vPortTickISR();
/*========================================================================*/
/*	GLOBAL VARIABLES						                              */
/*========================================================================*/
...
(uint32_t) &vPortTickISR,//dummy, /* Vector # 226 Periodic Interrupt Timer (PIT_0) channel 0 PIT_0 */
(uint32_t) &pit_ch1_ISR,//dummy, /* Vector # 227 Periodic Interrupt Timer (PIT_0) channel 1 PIT_0 */
